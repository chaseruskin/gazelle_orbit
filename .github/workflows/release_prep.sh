#!/usr/bin/env bash
# Build the gazelle_orbit release archive and emit release notes.
...
#
# Side effects:
#   Writes gazelle_orbit-${TAG}.tar.gz to the current directory. This
...
ARCHIVE="gazelle_orbit-${TAG}.tar.gz"
